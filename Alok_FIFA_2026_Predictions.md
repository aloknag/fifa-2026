...
| Jun 30 | R32 | CIV vs NOR | **1 - 2 (NOR)** | Pending | — | ✅ SUBMITTED + reload-verified. Norway slight fav (48%, Haaland/Ødegaard) but **leaky D (7 conceded in 3)** → **red-team fix from 1-0**: back the favorite but withhold the X-0 → **Norway wins 2-1, CIV nicking one = the `1 - 2 (NOR)` above**. Lowest-confidence; alt 1-1 (draw-prone even tie). 🎯 aim 6 · likely 3. |
