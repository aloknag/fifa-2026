...
| Jun 30 | FRA 3-0 SWE | **Miss (3 — outcome only): over-cautious X-0 withhold.** France was -400 and blew Sweden out 3-0. We predicted 2-1 to "leave room for Isak/Gyökeres" but Sweden were toothless (0 shots on target). **Rule: for a -350+ steamroller vs a weak opponent, default X-0 unless the opponent has a live striker confirmed in XI.** Isak/Gyökeres hype ≠ concrete threat. |
