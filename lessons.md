...
- **The one Jun 23 pick that worked proves the rule:** CRO PAN (predicted **2-0**, an X-0 → actual 1-0, banked 4pts) — we did NOT withhold (Panama toothless), took the clean-sheet zero. That is the template for heavy-favorite-vs-weak: X-0, every time.
