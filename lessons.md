...
| Jun 30 | FRA 3-0 SWE | **Miss (3 — outcome only): over-cautious X-0 withhold.** France was -400 and blew Sweden out 3-0. We predicted 2-1 to "leave room for Isak/Gyökeres" but France dominated (12 shots on target — their most in a WC knockout since 1966) and kept the clean sheet. **Rule: for a -350+ steamroller vs a weak opponent, default X-0 unless the opponent has a live striker confirmed in XI.** Isak/Gyökeres hype ≠ concrete threat. |
