...
- Separate **one-time** tournament bonuses (not per-match; locked pre-tournament, confirmed on the Pollaya `/puntos` page and documented in `CLAUDE.md` §1): **pick the champion +10, pick the runner-up +10.**
