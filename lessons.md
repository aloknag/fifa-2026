...
**Last updated:** 2026-06-25 — graded Jun 24 slate (**+14 pts**, 4/6 outcomes, no exacts, one zero: BIH 3-1 QAT = 3, SUI 2-1 CAN = 1, BRA 3-0 SCO = 4, MAR 4-2 HAI = 3, RSA 1-0 KOR = 0, MEX 3-0 CZE = 3 → **140/318** from 53 graded). **No new version** — solid slate, but two MD3 tails to weight: (1) **stakes-asymmetry upset** (RSA 1-0 KOR — a fav needing only a draw turned passive and lost to a must-win underdog), and (2) **eliminated-team X-0 breaks** (BIH 3-1 QAT, MAR 4-2 HAI — already-out sides played free and scored through our clean sheets). Both single/double instances → yellow flags, not a ≥3 pattern, no bump (anti-whipsaw). **Rule 5 validated** on first use (SUI-CAN 1-1 banked 1pt where a one-sided pick scored 0). The exact well is dry (0 across Jun 23–24) — converting floors to 6s remains the gap-closer. _(Prior: 2026-06-24 — graded Jun 23 +11; introduced v2.11 + Rule 5.)_
...
- **Jun 24 (+14, 4/6 outcomes) was a fine slate held back by zero exacts and one zero.** X-0 paid where the opponent bunkered (BRA 3-0 SCO = 4) but broke where an eliminated side played free (BIH 3-1 QAT, MAR 4-2 HAI). The zero was RSA 1-0 KOR — a stakes-asymmetry upset (KOR needed only a draw). Rule 5 validated (SUI-CAN 1-1 = 1pt vs the 0 a one-sided pick would've taken). **Standing (app screenshot Jun 25): Alok 4th at 141** (internal 140, +1 off-by-one confirmed) — Ricardo 149, Braiham 144, Roberto 142, Alok 141, Jesus 140. ⚠️ **Gap to 1st blew out 2 → 8:** on Jun 24 the leaders surged (Ricardo +20, Braiham/Roberto +16) while we got +14 with **zero exacts**. They are converting exacts; we are not. **The two-slate exact drought is now actively costing the lead — hunting 6s, not just banking floors, is the priority.**
