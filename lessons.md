...
- **Jun 24 (+14, 4/6 outcomes) was a fine slate held back by zero exacts and one zero.** X-0 paid where the opponent bunkered (BRA 3-0 SCO = 4) but broke where an eliminated side played free (QAT 3-1, HAI 4-2). The zero was RSA 1-0 KOR — a stakes-asymmetry upset (KOR needed only a draw). Rule 5 validated (SUI-CAN 1-1 = 1pt vs the 0 a one-sided pick would've taken). **Standing (app screenshot Jun 25): Alok 4th at 141** (internal 140, +1 off-by-one confirmed) — Ricardo 149, Braiham 144, Roberto 142, Alok 141, Jesus 140. ⚠️ **Gap to 1st blew out 2 → 8:** on Jun 24 the leaders surged (Ricardo +20, Braiham/Roberto +16) while we got +14 with **zero exacts**. They are converting exacts; we are not. **The two-slate exact drought is now actively costing the lead — hunting 6s, not just banking floors, is the priority.**
